...
def attention_seq2seq(input_len, output_len):
    ...
    encoder_outputs, state_h, state_c, state_h_rev, state_c_rev = encoder(embedded_input)
    initial_state = [state_h, state_c, state_h_rev, state_c_rev] # todo: initialize to zero?
...
def train(mode):
    ...
    model.summary()
    tb = TensorBoard(log_dir='./tb_logs/1017', histogram_freq=0, write_graph=True, write_images=False,
